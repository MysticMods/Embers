...
public class ModBlockEntity {
	...
	public static final BlockEntityEntry<EmberCrystallizerEntity> EMBER_CRYSTALLIZER = REGISTRATE.blockEntity("ember_crystallizer", EmberCrystallizerEntity::new).validBlocks(ModBlocks.EMBER_CRYSTALLIZER).register();
